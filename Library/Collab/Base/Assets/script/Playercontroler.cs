...
public class Playercontroler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        proportion_rouge = 1.0f / stateManager.instance.nbDash;
    ...
    void Update()
    {
        ...
        isgrounded = Physics.CheckSphere(new Vector3(transform.position.x, transform.position.y + (rend.bounds.size.y / 2), transform.position.z), .5f, groundlayer);
        Debug.Log(transform.position.y + (rend.bounds.size.y / 2));
    ...
    private void FixedUpdate()
    {
        ...
        if (rotation)
        {
            ...
            else animator.SetFloat("deplacement", 0);
